...
export const siteConfig = {
  ...
  description:"Access free AI-powered tools for students and professionals. Merge PDFs, create flashcards, fix grammar, write essays, solve homework. No sign-up required.",
  ...
  keywords: ["AI tools","free AI tools","AI writing assistant","AI study tools","productivity tools","text summarizer","paraphraser","grammar checker","essay writer","homework solver","flashcard maker","PDF tools","ToolNova",
  ],
