...
const faqs = [
  {
    ...
    answer:
      "Upload your image, drag the selection box over the area you want, use the corner handles to refine the size, then click Apply crop and Download. Everything runs in your browser.",
  },
  {
    question: "Can I lock the aspect ratio while cropping?",
    answer:
      "Yes. Choose presets like 1:1, 4:3, 16:9, or 9:16. Free mode lets you select any rectangle.",
  },
  {
    question: "Is my image uploaded to a server?",
    answer:
      "No. Cropping is processed entirely in your browser. Your file is not uploaded to ToolNova servers.",
  },
  {
...
export const metadata: Metadata = {
  ...
  description:
    "Crop any part of an image online free. Drag to select the region, lock aspect ratios (1:1, 16:9), and download PNG/JPG/WebP. Private browser crop tool — no signup.",
  keywords: [
    "crop image online free",
    "image crop tool select area",
    "crop photo free no signup",
    "crop image 1:1 16:9",
  ...
  openGraph: {
    ...
    description:
      "Drag-select any region and crop images free in your browser. No upload, no watermark.",
...
export default function ImageCropPage() {
  const description =
    "Free online image cropper with interactive selection. Choose any region, lock aspect ratios, and download the result — processed privately in your browser.";

  const toolSchema = getToolSchema(
    "Crop Image",
    description,
    "https://www.toolnovahub.com/tools/image-crop",
  );
