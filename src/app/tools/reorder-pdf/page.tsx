...
const faqs = [
  {
    ...
    answer:
      "Upload your PDF, wait for thumbnails, drag pages into the order you want (or use arrows), then download the reordered file. Everything runs in your browser.",
  },
  {
    question: "Is page quality reduced?",
    answer:
      "No. Thumbnails are only for preview. The downloaded PDF copies original page objects via pdf-lib without re-rendering content.",
  },
  {
...
export const metadata: Metadata = {
  ...
  description:
    "Reorder PDF pages free with visual thumbnails. Drag and drop pages, reverse or reset order, download instantly. Private browser tool — no signup.",
  keywords: [
    "reorder pdf pages free",
    "rearrange pdf online",
    "drag drop pdf pages",
    "pdf page order changer",
  ],
  alternates: { canonical: "https://www.toolnovahub.com/tools/reorder-pdf" },
  openGraph: {
    title: "Reorder PDF Pages Free | ToolNova",
    description:
      "Drag thumbnail pages to rearrange your PDF. Free and private.",
...
export default function ReorderPdfPage() {
  const description =
    "Free online PDF page reorder tool with thumbnails. Drag pages into any order and download — processed privately in your browser.";
    ...
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: schemaToJsonLd(
            getToolSchema(
              "Reorder PDF Pages",
              description,
              "https://www.toolnovahub.com/tools/reorder-pdf",
            ),
          ),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: schemaToJsonLd(
            getHowToSchema(
              "How to reorder PDF pages online free",
              description,
              steps.map((s) => ({
                name: s.title,
                text: s.desc,
