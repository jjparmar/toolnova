...
const generatePrompt = (input: string, options?: Record<string, any>) => {
  ...
  const sectionGuidance: Record<string, string> = {
    headline:"HEADLINE OPTIMIZATION (220 chars max): The most critical SEO real estate on LinkedIn. Must include: primary job title, key specialty, and unique value differentiator. Use the formula: [Title] | [Specialty] | [Value Prop/Result]. Include 2-3 searchable keywords recruiters use. Avoid creative-only titles (e.g., 'Ninja' or 'Guru')—balance personality with searchability.",
    about:"ABOUT SECTION (2,600 chars max): Your professional story told in first person. Structure: Hook (attention-grabbing opening line) → Problem (what challenges you solve) → Solution (your unique approach) → Proof (quantified achievements) → CTA (what you want readers to do). Include 10-15 relevant keywords naturally. Use short paragraphs (2-3 lines) and line breaks for readability. End with specialties/skills list.",
    experience:"EXPERIENCE SECTION: Transform job descriptions into achievement stories using STAR method (Situation → Task → Action → Result). Lead each bullet with a power verb. Quantify results (%, $, #) wherever possible. Show progression and increasing responsibility. Include 3-5 bullets per role, prioritized by impact. Add relevant keywords naturally.",
    full:"FULL PROFILE OPTIMIZATION: Optimize all sections holistically—Headline, About, Experience, Skills, and Featured. Ensure keyword consistency across sections. Create a cohesive personal brand narrative that flows from headline through experience. Maximize searchability while maintaining authentic voice.",
    skills:"SKILLS SECTION: Identify 50 relevant skills (LinkedIn max), prioritized by: 1) Most searched by recruiters in this industry, 2) Strongest competencies, 3) Trending/emerging skills. Include both hard skills (technical) and soft skills (leadership). Pin the top 3 most strategic skills. Group by category when listing.",
  };

  const experienceGuidance: Record<string, string> = {
    entry:"ENTRY-LEVEL FOCUS: Emphasize education, internships, projects, certifications, and transferable skills. Show eagerness to learn and grow. Highlight academic achievements, extracurriculars, and volunteer work. Use potential-focused language ('Equipped to...', 'Trained in...'). Focus on skills over experience length.",
    mid:"MID-LEVEL FOCUS: Balance proven track record with growth trajectory. Quantify achievements extensively (revenue, efficiency, team size). Show leadership abilities and cross-functional collaboration. Demonstrate domain expertise and specialization. Include certifications and continuous learning.",
    senior:"SENIOR-LEVEL FOCUS: Position as a strategic leader and thought leader. Emphasize business impact (P&L, market share, org transformations). Show mentorship and team building. Demonstrate industry influence (speaking, publications, board positions). Focus on vision and strategy over tactical execution.",
    executive:"EXECUTIVE-LEVEL FOCUS: Present as a transformational leader. Highlight company-level and industry-level impact. Emphasize board experience, M&A, fundraising, and P&L ownership. Show thought leadership through media mentions, keynotes, and publications. Use language that conveys authority and vision.",
  };

  // Keys MUST match toolOptions values (tech, marketing, finance, healthcare, sales, general)
  const industryKeywords: Record<string, string> = {
    tech:"TECH KEYWORDS: Software Development, Cloud Computing, AI/ML, DevOps, Agile, Scrum, Full-Stack, Data Science, Cybersecurity, SaaS, API, Microservices, CI/CD, Product Management, UX/UI, React, Python, AWS, Azure, Digital Transformation",
    marketing:"MARKETING KEYWORDS: Digital Marketing, SEO, SEM, Content Strategy, Brand Management, Marketing Analytics, Social Media Marketing, Growth Hacking, CRM, HubSpot, Google Analytics, Conversion Optimization, Campaign Management, Market Research, ABM, ROI",
    finance:"FINANCE KEYWORDS: Financial Analysis, Investment Banking, Portfolio Management, Risk Assessment, Financial Modeling, M&A, Private Equity, Compliance, Fintech, Bloomberg, Valuation, Capital Markets, Forecasting, P&L, Revenue Growth, FP&A",
    healthcare:"HEALTHCARE KEYWORDS: Clinical Research, Patient Care, HIPAA, EHR, Healthcare Analytics, Telemedicine, Population Health, Quality Improvement, Regulatory Compliance, Clinical Trials, Medical Devices, Pharmacovigilance, Value-Based Care",
    sales:"SALES KEYWORDS: B2B Sales, Pipeline Management, CRM, Salesforce, Quota Attainment, Enterprise Sales, Account Management, Lead Generation, Negotiation, Customer Success, ARR, SaaS Sales, Discovery Calls, Closing",
    general:"GENERAL KEYWORDS: Project Management, Leadership, Strategic Planning, Data Analysis, Team Building, Process Improvement, Stakeholder Management, Cross-functional Collaboration, Problem Solving, Communication, Change Management, Innovation",
  };

  // Keys MUST match toolOptions focus values
  const focusStrategy: Record<string, string> = {
    keywords:"KEYWORD OPTIMIZATION: Maximize search visibility. Weave relevant job titles, skills, tools, and industry terms naturally. Prefer searchable phrases recruiters actually use — never keyword-stuff.",
    engagement:"ENGAGEMENT FOCUS: Write in a warm, scannable voice that invites connection. Clear hook, short paragraphs, conversational first person, and a soft CTA (message/connect). Optimize for human readers first, SEO second.",
    achievements:"ACHIEVEMENT FOCUS: Lead with real results from the user's input. Use CAR (Challenge → Action → Result) only with facts they provided. If metrics are missing, describe impact qualitatively — never invent numbers.",
    network:"NETWORKING FOCUS: Position for outreach and collaboration. Clear who they help, what problems they solve, and who should connect. Include a friendly CTA and collaboration-friendly language without sounding spammy.",
  };
...
const placeholders = ["Software Engineer | Full-Stack Developer | React, Node.js, Python Expert | Building Scalable Solutions","About: Passionate marketing professional with 5+ years driving B2B growth. Led campaigns generating $2M+ revenue. Expertise in content strategy, SEO, and marketing automation. Seeking opportunities to help SaaS companies scale their customer acquisition.","Current role: Product Manager at Tech Startup. 3 years experience launching mobile apps with 1M+ downloads. Strong in user research, agile methodology, and cross-functional team leadership.","Sales professional with 7 years in enterprise B2B. Consistently exceeding quota by 150%. Expert in consultative selling, account management, and building C-suite relationships. Looking to join high-growth fintech company.","Healthcare administrator with MBA and 10+ years hospital management experience. Led department transformations improving patient satisfaction by 40%. Skilled in operations optimization, budgeting, and regulatory compliance.","Tech leader specializing in AI/ML solutions. Built data science teams at Fortune 500 companies. Open to remote CTO or VP Engineering roles. Passionate about using technology to solve complex business problems.",
];
