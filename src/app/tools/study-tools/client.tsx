                                ...
                                <div className="relative">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            <h3 className="text-foreground text-xl font-bold mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 transition-all">
                                                {tool.name}
                                            </h3>
                                    ...
                                    <div className="mt-6 flex items-center justify-between">
                                        ...
                                        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-card/40 backdrop-blur-md text-blue-600 shadow-lg group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-purple-500 group-hover:text-white group-hover:scale-110 transition-all duration-300">
