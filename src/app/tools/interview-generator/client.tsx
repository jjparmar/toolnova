...
const generatePrompt = (input: string, options?: Record<string, any>) => {
  ...
  const roleGuidance: Record<string, string> = {
    technical:"Coding problems, algorithms, system design, debugging scenarios, technical concepts, architecture decisions, problem-solving approach, code quality, and scalability thinking.",
    behavioral:"Past experiences using STAR method, teamwork scenarios, conflict resolution, adaptability, leadership moments, failure handling, communication skills, and cultural fit.",
    managerial:"Leadership philosophy, team building, performance management, strategic planning, difficult conversations, delegation, stakeholder management, and organizational impact.",
    creative:"Portfolio review, creative process, design thinking, innovation approach, handling feedback, collaboration with non-creatives, meeting deadlines, and project examples.",
    general:"Balanced mix: background/experience (30%), technical/role skills (40%), motivation/culture fit (20%), scenario-based problem-solving (10%).",
  };

  const difficultyGuidance: Record<string, string> = {
    entry:"Foundation and potential focus. Questions about education, projects, internships, willingness to learn, basic skills, cultural fit, and career goals. Assess aptitude over experience.",
    ...
    senior:"Leadership and strategic focus. Questions about organizational impact, mentoring, decision-making, handling ambiguity, driving initiatives, technical leadership, and long-term vision. Expect executive-level thinking.",
  };
...
const features = [
  {
    ...
    description:"Get technical, behavioral, managerial, creative, or general questions tailored to your target position.",
  },
  {
    icon: CheckCircle,
    title:"STAR Method Answers",
    description:"Sample answers using the proven STAR framework with specific examples and measurable results.",
  },
  {
    icon: TrendingUp,
    title:"Level-Appropriate",
    description:"Questions matched to entry, mid, or senior level expectations with appropriate difficulty and depth.",
  },
];
